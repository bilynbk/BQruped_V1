...
syms lD
u = [IB IF kB kF kS lB lF lD alpha Fr];
...
% lower segment length lD, upper segment length lU, lU = 0.7*lD
%l^2 = 1.49*lD^2-1.4*lD*cos(beta)--> cos(beta) = (1.49*lD^2-l^2)/(1.4*lD^2); l^2 = (xBH-xBFoot)^2+zBH^2; xBH-xBFoot = lB*cos(alpha)   
xBH = xB - lB*cos(thetaB);
zBH = zB - lB*sin(thetaB);
xFH = xF + lF*cos(thetaF);
zFH = zF + lF*sin(thetaF);

betaB = acos((1.49*lD^2-cos(alpha)^2-(zB-lB*sin(thetaB))^2)/(1.4*lD^2));
betaF = acos((1.49*lD^2-cos(alpha)^2-(zF-lF*sin(thetaF))^2)/(1.4*lD^2));
